...
export const scanTradingView = async (pairs) => {
    ...
    for (let i = 0; i < responseData.data.length; i++) {
        priceData.push({
            ...
            h4_close: responseData.data[i]["d"][20],
            h4_ema200: responseData.data[i]["d"][21],
            d1_close: responseData.data[i]["d"][22],
            d1_ema200: responseData.data[i]["d"][23],
            w1_close: responseData.data[i]["d"][24],
            w1_ema200: responseData.data[i]["d"][25],
        })
    }
